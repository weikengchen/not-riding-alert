...
public class StrategyCalculator {
    ...
    /**
     * Returns a RideGoal for a single ride, or null if it can't be computed (e.g. UNKNOWN, or ride time not set).
     * Does not apply seasonal/hidden filters (for use when showing the current ride outside the top list).
     */
