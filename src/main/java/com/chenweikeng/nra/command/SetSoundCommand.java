        ...
        dispatcher.register(ClientCommandManager.literal("nra:setalertsound")
            .then(ClientCommandManager.argument("soundId", StringArgumentType.string())
                .executes(context -> {
                    ...
                    context.getSource().sendFeedback(Component.literal("Sound ID set to: " + soundId));
            ...
            .executes(context -> {
                ...
                context.getSource().sendFeedback(Component.literal("Current sound ID: " + currentSound));
                return 1;
            })
        );
    }
