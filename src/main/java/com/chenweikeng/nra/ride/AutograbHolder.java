...
public enum AutograbHolder {
  ...
  GUARDIANS_OF_THE_GALAXY_MISSION_BREAKOUT(
      ...
      isDlnew(),
      new Point(-338.06, -723.80),
      64,
      new Point(-342.4430053290551, -727.3701642398231),
      new Point(-335.04148636399464, -724.685510003613),
      new Point(-335.02572639756926, -723.9295354118144),
      new Point(-335.07027749091475, -721.0288850095053),
      new Point(-338.64921284804007, -721.0181445845936)),
  ...
  public static RideName getRideAtLocation(Minecraft client) {
    ...
    for (AutograbHolder region : values()) {
